...
namespace TasksApi.Services
{
    public class TaskService : ITaskService
    {
        ...
        //GetAllTasks() for super user to see all tasks
        public async Task<GetTasksResponse> GetAllTasks()
		{
            var allTasks = await tasksDbContext.Tasks.ToListAsync();

            return new GetTasksResponse { Success = true, Members = allTasks };
        }
		...
		public async Task<GetTasksResponse> GetTasks(int userId)
        {
            ...
            return new GetTasksResponse { Success = true, Members = tasks };

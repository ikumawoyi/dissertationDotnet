...
namespace TasksApi.Controllers
{
    ...
    public class TasksController : BaseApiController
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            var tasksResponse = getTasksResponse.Members.ConvertAll(o => new TaskResponse { Id = o.Id, IsCompleted = o.IsCompleted, Name = o.Name, Ts = o.Ts });
        ...
        {
            var getAllTasksResponse = await taskService.GetAllTasks();

            if (!getAllTasksResponse.Success)
            {
                return UnprocessableEntity(getAllTasksResponse);
            }

            var tasksResponse = getAllTasksResponse.Members.ConvertAll(o => new TaskResponse { Id = o.Id, IsCompleted = o.IsCompleted, Name = o.Name, Ts = o.Ts });
